    ...
    <>
      ...
      <h2 className="text-center">SignUp</h2>
        <Form.Group className="mb-2" controlId="formBasicEmail">
          ...
          <Form.Control ref={handleName} type="text" placeholder="Enter your name" />
        </Form.Group>
        <Form.Group className="mb-2" controlId="formBasicEmail">
          <Form.Label>Email address</Form.Label>
          <Form.Control ref={handleEmail} type="email" placeholder="Enter email" required />
        </Form.Group>
        <Form.Group className="mb-2" controlId="formBasicPassword">
          <Form.Label>Password</Form.Label>
          <Form.Control ref={handlePassword} type="password" placeholder="Password" required/>
        </Form.Group>
        <Form.Group className="" controlId="formBasicPassword">
          <Form.Label>Confirm Password</Form.Label>
          <Form.Control ref={handleConPass} type="password" placeholder="Confirm Password" required/>
        </Form.Group>
        <p className="text-danger mb-2" style={{fontSize: '14px'}}>{error}</p>
        ...
        <Form.Group className="mb-2 d-flex" controlId="formBasicCheckbox">
          ...
          <label className={`${agree ? 'ms-2 text-success' : 'text-danger ms-2'}`} htmlFor="terms">Accept our terms and condition</label>
        </Form.Group>
        <p className="mb-0 mt-2">Already have an account? <Link to='/login'>Login</Link></p>
